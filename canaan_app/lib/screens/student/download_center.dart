...
///
/// Read-only, download-only: students see Student + Everyone content
/// (filtered at the query level), then download files and open them
/// with their own device apps. No inline viewer/player.
class StudentDownloadCenterPage extends StatefulWidget {
  const StudentDownloadCenterPage({super.key});

  @override
  State<StudentDownloadCenterPage> createState() =>
      _StudentDownloadCenterPageState();
}

class _StudentDownloadCenterPageState
    extends State<StudentDownloadCenterPage> {
  ...
  /// Audience filtering at the query level: students + everyone only.
