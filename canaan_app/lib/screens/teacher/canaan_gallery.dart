...
/// Teacher Dashboard → Quick Links → Canaan Gallery.
///
/// Read-only: teachers see every published gallery. Realtime delivery —
/// new Admin galleries appear automatically.
class TeacherCanaanGalleryPage extends StatefulWidget {
  final String teacherId;
  final String teacherName;
  final String? section;
  const TeacherCanaanGalleryPage({
    super.key,
    this.teacherId = '',
    this.teacherName = '',
    this.section,
  ...
  @override
  State<TeacherCanaanGalleryPage> createState() =>
      _TeacherCanaanGalleryPageState();
}

class _TeacherCanaanGalleryPageState
    extends State<TeacherCanaanGalleryPage> {
  ...
  Future<void> _fetchAll({bool silent = false}) async {
    ...
    try {
      ...
      final posts = List<Map<String, dynamic>>.from(results[0] as List)
          .where((p) => GalleryService.visibleTo(p, role: 'teacher'))
          .toList();
      final photos =
